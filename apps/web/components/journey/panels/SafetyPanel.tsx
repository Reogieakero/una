  ...
  return (
    <JourneyPanel id="j-safety" width="w-[100vw]">
      <div className="mx-auto max-w-6xl">
        <div className="overflow-hidden rounded-[2.5rem] border border-white/60 bg-gradient-to-br from-blue-50 via-white to-yellow-50 p-8 shadow-soft">
            ...
            <JourneyHeading
              ...
              title={
                <>
                  ...
                  <span className="text-blue-600">Built that way.</span>
                </>
              }
