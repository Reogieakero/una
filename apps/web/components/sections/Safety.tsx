  ...
  return (
    <section id="safety" aria-labelledby="safety-heading" className="relative py-20 lg:py-28">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="overflow-hidden rounded-[2.5rem] border border-white/60 bg-gradient-to-br from-blue-50 via-white to-yellow-50 p-8 shadow-soft sm:p-12 lg:p-16">
          <AnimatedSection className="mx-auto max-w-2xl text-center">
            <Eyebrow>Safety & privacy</Eyebrow>
            <h2 id="safety-heading" className="mt-4 text-3xl font-semibold sm:text-[2.6rem]">
               Your story stays yours. <span className="text-blue-600">We built it that way.</span>
            </h2>
          ...
          <AnimatedSection delay={0.15} className="mt-8">
            <p className="mx-auto max-w-3xl rounded-2xl bg-blue-600 px-6 py-4 text-center text-[15px] font-medium leading-relaxed text-white shadow-soft">
