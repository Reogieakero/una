...
function FeatureCard({ f, i }: { f: Feature; i: number }) {
  ...
  return (
    ...
    >
      ...
      <div className="mt-auto flex items-center gap-2 pt-5 text-sm font-bold text-blue-600">
        <span className="h-1.5 w-8 rounded-full bg-blue-200 transition-all duration-300 group-hover:w-12 group-hover:bg-blue-500" aria-hidden />
        Made for DOrSU
      </div>
    </article>
  );
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 id="features-heading" className="mt-4 text-3xl font-semibold sm:text-[2.6rem]">
             Key features, <span className="text-blue-600">designed with care.</span>
          </h2>
        ...
        >
          ...
          >
            ...
            <div className={active ? "contents" : "flex justify-center"}>
              <div className="flex h-[420px] w-[300px] shrink-0 flex-col items-start justify-center rounded-[1.75rem] bg-blue-600 p-8 text-white shadow-soft sm:w-[340px]">
                ...
                <a
                  href="#how-it-works"
                  className="mt-6 inline-flex items-center gap-2 rounded-full bg-white px-5 py-2.5 text-sm font-bold text-blue-700 transition-transform hover:-translate-y-0.5"
                >
          ...
          {active && (
            <div className="relative mx-auto mt-10 w-[min(560px,80vw)]">
              <div className="h-1.5 overflow-hidden rounded-full bg-blue-100">
                <motion.div style={{ scaleX: progress }} className="h-full w-full origin-left rounded-full bg-gradient-to-r from-blue-500 via-blue-400 to-yellow-400" />
              </div>
