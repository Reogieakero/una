...
function MiniStep({ s, i }: { s: Step; i: number }) {
  ...
  return (
    <article className="relative flex h-[320px] w-[250px] shrink-0 flex-col rounded-[1.75rem] border border-white/60 bg-white/92 p-5 pt-8 shadow-card">
      <span
        aria-hidden
        className="absolute -top-4 left-6 flex h-9 w-9 items-center justify-center rounded-full bg-sage-600 font-display text-[15px] font-bold text-white shadow-soft"
      >
        {i + 1}
      </span>
