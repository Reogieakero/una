      ...
      <div className="relative mx-auto flex max-w-none items-center gap-[3vw]">
          ...
          <JourneyHeading
            ...
            title={
              <>
                ...
                <span className="text-sage-600">confident decisions.</span>
              </>
            }
        ...
        <AnimatedSection delay={0.08} className="w-[88vw] max-w-[1120px] shrink-0">
          <div className="overflow-hidden rounded-[2rem] border border-white/60 bg-white/85 shadow-soft backdrop-blur">
            <div className="flex flex-wrap items-center justify-between gap-2 border-b border-sage-100 px-5 py-3">
              <div className="flex items-center gap-2.5">
                <p className="text-[13px] font-bold">Guidance Analytics — sample preview</p>
                <Badge variant="sky">Live trends</Badge>
              </div>
              <span className="inline-flex items-center gap-1.5 rounded-full bg-sage-50 px-3 py-1 text-[11px] font-bold text-sage-700">
            ...
            <div className="grid grid-cols-[1.1fr_0.9fr] gap-4 p-5">
              <div>
                ...
                <div className="mt-3 rounded-2xl border border-sage-100 bg-white p-4">
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <span className="inline-flex items-center gap-1 rounded-full bg-peach-50 px-2 py-0.5 text-[11px] font-bold text-peach-600">
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex-1 rounded-2xl bg-sage-600 p-4 text-white">
                  ...
                  <p className="mt-2 inline-flex items-center gap-1.5 rounded-full bg-white px-3 py-1.5 text-[12px] font-bold text-sage-700">
