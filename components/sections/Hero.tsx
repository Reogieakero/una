  ...
  return (
    ...
    >
      ...
      <div aria-hidden className="absolute inset-0 -z-10">
        <div className="absolute inset-0 bg-[linear-gradient(180deg,#FDF8F1_0%,#EFF6F0_38%,#EFEAF8_72%,#FDF8F1_100%)]" />
        ...
        <div className="absolute bottom-0 left-1/3 h-72 w-72 rounded-full bg-skysoft-100/80 blur-[80px]" />
      </div>
      ...
      <div className="mx-auto grid max-w-6xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:gap-8">
        ...
        <div>
          ...
          >
            ...
            <span className="relative whitespace-nowrap text-sage-600">
              safe to start
              <svg
                aria-hidden
                viewBox="0 0 220 14"
        ...
        >
          ...
          <div
            aria-hidden
            className="absolute -inset-6 -z-10 rounded-[3rem] bg-[radial-gradient(circle_at_30%_20%,#C2DBC7_0%,transparent_55%),radial-gradient(circle_at_80%_70%,#D3C8F0_0%,transparent_55%)] opacity-70 blur-2xl animate-breathe"
          />
          <motion.div
          ...
          >
            <p className="text-[11px] font-bold uppercase tracking-wider text-sage-600">
              PSS-10 check-in
            </p>
            <p className="font-display text-2xl font-semibold">
              Moderate <span className="text-sm font-medium text-ink-muted">• 18/40</span>
            </p>
            <div className="mt-2 h-2 w-36 overflow-hidden rounded-full bg-sage-100">
              <motion.div
                initial={{ width: 0 }}
                animate={{ width: "45%" }}
          ...
          >
            <p className="text-[11px] font-bold uppercase tracking-wider text-lav-500">
              Next session
            </p>
